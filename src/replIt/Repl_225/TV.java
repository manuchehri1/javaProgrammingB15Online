...
//        Create isOn(), turnOn() and turnOff() methods for "on" instance variable.If tv is
//        already on, no need to turn it on again, display message: "TV is already ON".
//        If tv is already off, then no need to turn it off again, display message:
//        "TV is already OFF".
